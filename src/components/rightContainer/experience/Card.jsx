...
const Card = ({
  ...
  return (
    <div className={`${!isExperienceCard && 'items-center'} flex flex-col md:flex-row group cursor-pointer py-4 lg:p-4 rounded-lg mb-4  lg:hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:hover:drop-shadow-lg`}>
      {isExperienceCard ? (
